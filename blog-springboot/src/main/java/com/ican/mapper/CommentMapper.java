...
public interface CommentMapper extends BaseMapper<Comment> {
     ...
     * @return 评论集合
     */
    List<CommentBackVO> listCommentBackVO(@Param("limit") Long limit, @Param("size") Long size, @Param("conditionQuery") ConditionQuery conditionQuery);
     ...
     * @return 评论数量
     */
    Long countComment(@Param("conditionQuery") ConditionQuery conditionQuery);
     ...
     * @return 评论集合
     */
    List<CommentVO> selectParentComment(@Param("limit") Long limit, @Param("size") Long size, @Param("conditionQuery") ConditionQuery conditionQuery);
