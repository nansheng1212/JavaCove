      ...
      <div class="reply-item" v-for="(comment, index) of commentList" :key="comment.id">
        ...
        <div class="content-warp">
          ...
          <div class="reply-info">
            <span class="reply-time">{{ formatDateTime(comment.createTime) }}·{{comment.ipSource}}</span>
          ...
          <div class="sub-reply-item" v-for="reply of comment.replyVOList" :key="reply.id">
            ...
            <div class="reply-info">
              <span class="reply-time">{{ formatDateTime(reply.createTime) }}·{{reply.ipSource}}</span>
