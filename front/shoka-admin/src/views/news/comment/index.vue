<template>
    <div class="app-container">
        ...
        <el-table border :data="commentList" @selection-change="handleSelectionChange" v-loading="loading">
            ...
            <el-table-column prop="commentContent" label="IP地址" align="center">
              <template #default="scope">
                <span v-html="scope.row.ipAddress" class="comment-content" />
              </template>
            </el-table-column>
            <el-table-column prop="commentContent" label="IP归属地" align="center">
              <template #default="scope">
                <span v-html="scope.row.ipSource" class="comment-content" />
              </template>
            </el-table-column>
            <!-- 评论时间 -->
